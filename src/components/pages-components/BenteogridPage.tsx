...
import { AnimatedBeamDemo } from "../base-components/AnimatedBeamDemo";
...
const features = [
  {
    ...
    description: "See what our customers think about us",
    href: "#",
    cta: "Learn more",
  ...
  },
  {
    Icon: Share2Icon,
    name: "Integrations",
    description: "Supports 10+ tech integrations.",
    href: "#",
    cta: "Learn more",
    className: "col-span-3 lg:col-span-2",
    background: (
